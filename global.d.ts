...
declare const importClass: any;
declare const importPackage: any;
...
declare const PackageManager: any;
declare const URL: any;
declare const FileOutputStream: any;
declare const java: any;
declare const android: any;
declare const util: any;
declare const Build: any;
declare const captureScreen = images.captureScreen;
...
namespace images {
  ...
  function fromBytes(bitmap: any): Image;
  function toBase64(...args: any[]): string;
  ...
  function getSimilarity(img1: Image, img2: Image, options?: any): number;
  function threshold(
    img: Image,
    threshold: number,
    maxVal: number,
  ...
  function matchTemplate(
    ...
    template: Image,
    options?: any
  ): { matches: { point: Point; similarity: number }[]; points: Point[] };
  ...
  function detectAndComputeFeatures(
    img: Image,
    options?: {
      scale?: number;
      grayscale?: boolean;
  ...
  function toBytes(image: Image, format: string, p: number): any;
  function grayscale(image: Image): Image;
  function matchFeatures(scene: any, object: any);
}
